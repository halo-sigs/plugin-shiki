...
function highlightAllCodeBlock() {
    ...
    codeElements.forEach((codeblock) => {
        ...
        const theme = extractThemeFromPreElement(codeblock.parentElement as HTMLPreElement) || "github-light";

        console.log(theme);
        console.log(extractThemeFromPreElement(codeblock.parentElement as HTMLPreElement));
